...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/mahjong/releases/download/v1.0.0/mahjong.zip
SET REPO_NAME=mahjong.zip
SET EXTRACTED_REPO_DIR=mahjong
